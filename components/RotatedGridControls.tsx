...
export default function RotatedGridControls({ params, onParamChange, onColorChange, onExportImage, onExportWallpapers, onRandomize, onRegenerate, tokenInput, onTokenChange }: RotatedGridControlsProps) {
