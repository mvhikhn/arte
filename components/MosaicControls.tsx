...
export default function MosaicControls({ params, onParamChange, onColorChange, onExportImage, onExportWallpapers, onRandomize, onRegenerate, tokenInput, onTokenChange }: MosaicControlsProps) {
